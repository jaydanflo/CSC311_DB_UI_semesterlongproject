...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311_BD_TEMP";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://server.csc311florianserver.database.azure.com/";
        final static String DB_URL = SQL_SERVER_URL + DB_NAME;
        final static String USERNAME = "jaydanflorian";// update this username
